...
namespace Printer_BDD.Features.Functionalities
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("SpecFlowFeature1", Description="\tSimple calculator for adding two numbers", SourceFile="Features\\Functionalities\\Copy.feature", SourceLine=0)]
